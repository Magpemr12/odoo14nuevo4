...
class HrExpense(models.Model):
    ...
    def create_partner_from_cfdi(self):
        ...
        for expense in self.filtered('l10n_mx_edi_rfc'):
            ...
            global_partner = self.env['ir.config_parameter'].sudo().get_param(
                'l10n_mx_edi_hr_expense.global_partner')
   ...
   <ns1:Body>
    ...
    def l10n_mx_edi_get_invoice_data(self, inv):
        ...
        for line in inv.get('lines', []):
            ...
            account = prod.browse(
                product).product_tmpl_id.get_product_accounts()['expense'].id if res else account
            amount = line['amount']
            ...
            for tax in inv.get('local_taxes'):
                if tax['tax'].upper() in self._get_taxes_to_omit():
                    nl_data = self.create_extra_line_local_taxes(tax)
