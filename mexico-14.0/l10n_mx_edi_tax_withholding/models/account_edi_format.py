...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_mx_edi_export_payment_cfdi(self, move):
        ...
        factor = payment.l10n_mx_edi_tax_withholding_rate if payment.currency_id != payment.company_id.currency_id else 1  # noqa,
        cfdi_values = {
            **self._l10n_mx_edi_get_common_cfdi_values(move),
            ...
            'tax_withholding_type': dict(move.payment_id._fields[
                'l10n_mx_edi_tax_withholding_type']._description_selection(self.env)).get(str(
                    move.payment_id.l10n_mx_edi_tax_withholding_type), ''),
        ...
        cfdi_cadena_crypted = cfdi_values['certificate'].sudo().get_encrypted_cadena(
            get_cadena(fromstring(cfdi), XSLT_CADENA), 'sha1')
